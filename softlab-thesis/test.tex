...
Η λύση αυτού του προβλήματος, που δόθηκε στη δεκαετία του '80 για τη γλώσσα Scheme, ήταν η χρήση της βελτιστοποίησης 
...
\begin{abstracten}%
  ...
  The solution to this problem, given in 1980's for Scheme, was the use of the tail-call
...
The main optimisation this thesis discusses is the tail-call optimisation. This optimisation, first found in Scheme and
...
\textbf{[TODO : Write more about the folloeing transformations]}
\begin{itemize}
  \item alpha-renaming
